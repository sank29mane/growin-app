...
class QuantEngine:
    ...
    def calculate_portfolio_metrics(self, positions: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        # ⚡ Bolt: Use a single pass instead of multiple list comprehensions and zip
        # to avoid constructing intermediate lists and to reduce memory overhead from O(N) to O(1).
        for p in positions:
